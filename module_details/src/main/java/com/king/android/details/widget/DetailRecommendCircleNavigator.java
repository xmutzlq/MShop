package com.king.android.details.widget;
...
public class DetailRecommendCircleNavigator extends View implements IPagerNavigator {
    private int mRadius;
    ...
    public DetailRecommendCircleNavigator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mIndicatorColor = ContextCompat.getColor(context, R.color.color_ff3234);
        mCircleColor = Color.LTGRAY;
    }
    ...
    private void drawIndicator(Canvas canvas) {
        ...
        if (mCirclePoints.size() > 0) {
            canvas.drawCircle(mIndicatorX, (int) (getHeight() / 2.0f + 0.5f), mRadius, mIndicatorPaint);
        }
    }

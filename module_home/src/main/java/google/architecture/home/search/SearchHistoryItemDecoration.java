package google.architecture.home.search;
...
public class SearchHistoryItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SearchHistoryItemDecoration(Context context, int orientation) {
    ...
    public SearchHistoryItemDecoration(Context context, int orientation, int drawableId) {
    ...
    public SearchHistoryItemDecoration(Context context, int orientation, Drawable divider) {
        init(orientation, divider);
    }

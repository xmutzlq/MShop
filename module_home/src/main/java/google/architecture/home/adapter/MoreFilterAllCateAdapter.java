...
public class MoreFilterAllCateAdapter extends BaseAdapter implements StickyListHeadersAdapter, SectionIndexer {
    ...
    public MoreFilterAllCateAdapter(Context context, List<MoreFilterCatesData> infos) {
        mContext = context;
        mInfos = infos;
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.filter_item_all_cate_header, null);
            holder.headerName = convertView.findViewById(R.id.filter_all_cate_item_label);
            holder.headerLL = convertView.findViewById(R.id.filter_all_cate_item_arrow_btn);
            holder.headerRightIv =  convertView.findViewById(R.id.filter_all_cate_item_arrow_iv);
            convertView.setTag(holder);
        } else {
            holder = (HeaderViewHolder) convertView.getTag();
        }
        holder.headerName.setText(mInfos.get(position).cateName);
        if(mInfos.get(position).isExpand) {
            holder.headerRightIv.setImageResource(R.mipmap.ic_filter_arrow_up_normal);
        } else {
            holder.headerRightIv.setImageResource(R.mipmap.ic_filter_arrow_down_normal);
        }
        return convertView;
    }

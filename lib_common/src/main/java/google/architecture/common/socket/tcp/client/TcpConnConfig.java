...
import google.architecture.common.socket.tcp.client.helper.decode.AbsDecodeHelper;
import google.architecture.common.socket.tcp.client.helper.decode.BaseDecodeHelper;
import google.architecture.common.socket.tcp.client.helper.stickpackage.AbsStickPackageHelper;
import google.architecture.common.socket.tcp.client.helper.stickpackage.BaseStickPackageHelper;
import google.architecture.common.socket.tcp.client.helper.validation.AbsValidationHelper;
import google.architecture.common.socket.tcp.client.helper.validation.BaseValidationHelper;
...
public class TcpConnConfig {
    ...
    private int faildReconnectCount = 10; //失败后重连次数
    ...
    public int getFaildReconnectCount() {
		return faildReconnectCount;
	}
    ...
    public static class Builder {
    	...
    	public Builder setFaildReconnectCount(int faildReconnectCount) {
    		mTcpConnConfig.faildReconnectCount = faildReconnectCount;
    		return this;
    	}
